...
def extract_notes(file_path, sample_interval=10):
...
# 使用音频文件
audio_file = r"separated/htdemucs/music_2/other.wav"
notes = extract_notes(audio_file, sample_interval=20)
plot_notes(notes, notes_per_line=60, output_file=r"wav/score2.png", staff_spacing=1)

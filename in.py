...
class MainWindow(QDialog, Ui_Dialog):
    def __init__(self):
        ...
        self.separate_worker = WorkerThread(self.separate_audio, r"wav\music_1.wav")
        self.separate_worker.finished.connect(self.task_finished)

        self.output_lyrics_worker = WorkerThread(self.output_lyrics, r"separated\htdemucs\music_1\vocals.wav",
                              r"separated\htdemucs\music_1\vocals_1.wav")
        self.output_lyrics_worker.finished.connect(self.task_finished)

        self.output_worker = WorkerThread(self.output_score, r"wav\music_1.wav", r"wav\note_1.txt")
        self.output_worker.finished.connect(self.task_finished)
    ...
    def task_finished(self, task_name):
        """任务完成后的回调函数"""
        self.label_1.setText("任务完成！")
        print(f"{task_name} 任务完成！")
        self.enable_buttons()

    def pushButton_1_clicked(self):
        self.label_1.setText("分离音频...")
        self.disable_buttons()

        self.separate_worker.start()

    def pushButton_2_clicked(self):
        self.label_1.setText("输出歌词...")
        self.disable_buttons()

        self.output_lyrics_worker.start()

    def pushButton_3_clicked(self):
        self.label_1.setText("输出乐谱...")
        self.disable_buttons()
